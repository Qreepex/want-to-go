...
const COUNTRY_TO_CONTINENT: Record<string, string> = {
	...
	IL: 'AS', JP: 'AS', JO: 'AS', KZ: 'AS', KP: 'AS', KR: 'AS', KW: 'AS', KG: 'AS',
	LA: 'AS', LB: 'AS', MO: 'AS', MY: 'AS', MV: 'AS', MN: 'AS', MM: 'AS', NP: 'AS',
	OM: 'AS', PK: 'AS', PS: 'AS', PH: 'AS', QA: 'AS', SA: 'AS', SG: 'AS', LK: 'AS',
	...
	GR: 'EU', GG: 'EU', VA: 'EU', HU: 'EU', IS: 'EU', IE: 'EU', IM: 'EU', IT: 'EU',
	JE: 'EU', XK: 'EU', LV: 'EU', LI: 'EU', LT: 'EU', LU: 'EU', MT: 'EU', MD: 'EU',
	MC: 'EU', ME: 'EU', NL: 'EU', MK: 'EU', NO: 'EU', PL: 'EU', PT: 'EU', RO: 'EU',
	RU: 'EU', SM: 'EU', RS: 'EU', SK: 'EU', SI: 'EU', ES: 'EU', SE: 'EU', CH: 'EU',
	UA: 'EU', GB: 'EU', AX: 'EU',

	AG: 'NA', AI: 'NA', AW: 'NA', BS: 'NA', BB: 'NA', BZ: 'NA', BM: 'NA', VG: 'NA',
	...
	AS: 'OC', AU: 'OC', CX: 'OC', CC: 'OC', CK: 'OC', FJ: 'OC', PF: 'OC', GU: 'OC',
	KI: 'OC', MH: 'OC', FM: 'OC', NR: 'OC', NC: 'OC', NZ: 'OC', NU: 'OC', NF: 'OC',
	MP: 'OC', PW: 'OC', PG: 'OC', PN: 'OC', WS: 'OC', SB: 'OC', TK: 'OC', TO: 'OC',
	TV: 'OC', UM: 'OC', VU: 'OC', WF: 'OC',
